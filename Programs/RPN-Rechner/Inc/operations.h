...
/**
 ******************************************************************************
 *  @brief      Speichert eine gegebene Nummer
 *  @param      num => Zu speichernde Nummer
...
/**
 ******************************************************************************
 *  @brief      Gibt das oberste oder alle Elemente im Stack
 *              auf den Bildschirm aus.
 *  @param      token => PRT_ALL fuer komplette Ausgabe
 *  @return     void
 ******************************************************************************
*/
